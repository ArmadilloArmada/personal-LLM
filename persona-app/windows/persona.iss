; Persona + Big Brain Windows installer (Inno Setup 6)
...
Name: "{group}\Run Persona"; Filename: "{app}\Run Persona.bat"; WorkingDir: "{app}"
...
begin
  ...
  begin
    MsgBox('Your Persona data in %USERPROFILE%\.persona was kept.', mbInformation, MB_OK);
  end;
end;
